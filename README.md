...
**Логи мониторинга** — чтобы сводные логи активности пользователей приходили в канал/чат Telegram, укажите в `.env` **LOG_CHAT_ID** (числовой chat_id канала или чата). Либо отправьте боту `/start` в нужном чате — бот сохранит его для логов. Подробнее: [docs/DEPLOY_RAILWAY.md](docs/DEPLOY_RAILWAY.md).
